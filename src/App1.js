...
import { Box, Container, Typography, Button, Card, CardContent, CardMedia, AppBar, Toolbar, IconButton, InputBase, Badge, Dialog, DialogTitle, DialogContent, TextField, Paper, Chip, Stack, Drawer, Grid, Tooltip, Zoom } from "@mui/material";
...
const ChatHeader = styled(DialogTitle)({
  background: "linear-gradient(45deg, #4CAF50, #81C784)",
  color: "#fff",
  padding: "16px"
});
...
const App = () => {
  ...
  const [messages, setMessages] = useState([{
    text: "Hello! How can I help you today? Choose from quick actions below or type your message.",
    sender: "bot"
  }]);
